#!/usr/bin/env python
"""
Entry point for AI content generation pipeline.
This script runs only the AI content generation part of the YouTube Shorts Generator.
"""
...
def main() -> int:
    ...
    logging.info("[START] New AI Content Run: %s", run_dir)
